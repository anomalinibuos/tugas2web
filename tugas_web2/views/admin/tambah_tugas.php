...
<div style="display:flex; justify-content:center; align-items:center; height:100vh;">
    ...
    <div style="width:400px; background:#ffffff; padding:25px; border-radius:10px; box-shadow:0 8px 20px rgba(0,0,0,0.15);">
        ...
        <form method="POST" action="/projek_web2/controllers/TugasController.php?action=store">
            ...
            <label>Deadline</label>
                <input type="date" name="deadline" required style="width:100%; padding:10px; margin:8px 0 20px; border:1px solid #ccc; border-radius:5px;">
            <button type="submit"
